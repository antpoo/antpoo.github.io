    ...
    return (
        <div className="flex flex-col items-center justify-center my-20">
            ...
            <div>
                ...
                <p className="my-8 text-gray-900">
                    In terms of programming experience, I have experience in many different languages and frameworks. This very website was created using React, TypeScript, and Tailwindcss. In my <a href="/projects" className="text-pink-600 hover:underline">projects</a>, I also have experience with HTML/CSS/JS, Python, Typescript, Java, React, Tailwindcss, Node.js, MongoDB, JavaFX, Flask, and Pygame. Additionally, I began my programming journey through competitive programming, spending most of my time on <a href="https://dmoj.ca/user/1jiangand2" target="_blank" className="text-pink-600 hover:underline">DMOJ: Modern Online Judge</a>, solving problems with C++, Java, and Python. I have written the <a href="https://cemc.uwaterloo.ca/contests/ccc-cco.html" target="_blank" className="text-pink-600 hover:underline">Canadian Computing Competition (CCC)</a> Senior Level twice, earning distinction (top quartile score) both times. I hope to improve day by day in both my project skills as well as my competitive programming skills!
                </p>
                <p className="my-8 text-gray-900">
